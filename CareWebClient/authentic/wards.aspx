<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wards.aspx.cs" Inherits="CareWebClient.authentic.wards" %>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="success">
                                                <td><%= x + 1 %></td>
                                                <td><%= WardDetails[x].CarekiddieFirstName %></td>
                                                <td><%= WardDetails[x].CarekiddieLastName %></td>
                                                <td><%= WardDetails[x].CarekiddieGender %></td>
                                                <td><%= WardDetails[x].Parents.ParentFullName %></td>
                                                <td>
                                                    ...
                                                    <a href="payment.aspx?key=<%=x %>" target="_blank"class="btn btn-primary btn-sm"><span class="glyphicon"></span>payment details <i class="fa fa-money" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                            <% }
                                                else
