<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CareWebClient.authentic.Index" %>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-bicycle "></i>Forms <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                             ...
                             <li>
                                <a href="profile.aspx"><i class="fa fa-desktop "></i>Basic </a>
                            </li>
                             <li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">This is a quick summary of the situation accessment. </h1>
                    ...
                    <div class="col-md-4">
                        <div class="main-box mb-dull">
                            <a href="#">
                                ...
                                <h5>Client review ratings<br/> 40%</h5>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="main-box mb-pink">
                            <a href="#">
                                ...
                                <h5>Current Balance<br/> &#8358;<%= this.CurrentBallance .ToString() %> </h5>
                            </a>
                        </div>
                    </div>
