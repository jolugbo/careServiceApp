<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="CareWebClient.Signup" %>
      ...
      <div class="signup__form">
        ...
        <div class="login__row">
          <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
            ...
            <asp:TextBox ID="txtUserName" type="text" class="login__input name" placeholder="Username" runat="server" required></asp:TextBox>
        </div>
        <div class="login__row">
         <%-- <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
            ...
            <asp:TextBox ID="txtEmail" type="email" class="login__input name" placeholder="Email Address" runat="server" required></asp:TextBox>
        </div>
        <div class="login__row">
        <%--  <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
            ...
            <asp:TextBox ID="txtPassword1" type="password" class="login__input name" placeholder="Password" runat="server" required></asp:TextBox>
        </div>
        <div class="login__row">
        <%--  <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            ...
            <i class="fa fa-key " aria-hidden="true"></i>
            <asp:TextBox ID="txtPassword2" type="password" class="login__input pass" placeholder="Verify Password" runat="server" required></asp:TextBox>
        </div>
      <asp:Button ID="btnlogin" class="login__submit" runat="server" Text="Join In" OnClientClick="return validatePass();" OnClick="signup_user" type="submit" />
        <p class="login__signup"> have an account? &nbsp;<a  href="login.aspx"  >Sign in</a></p>
